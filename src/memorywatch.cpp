            ...
            if (this->memInfoStream.is_open())
            {
                ...
                while(this->memInfoStream.good())
                {
                    ...
                    try
                    {
                        ...
                        memInfoMap.insert(pair<string, int>(v[0], boost::lexical_cast<int>(v[1])));
                    }
                    //TODO: we need to find a way to catch specific boost exceptions
                    catch(...)
                    {
...
//                    }
                ...
                boost::this_thread::sleep(boost::posix_time::milliseconds(this->cfg->waitMSThread));
            } else {
